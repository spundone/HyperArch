...
StyledRect {
    ...
    color: root.modelData.urgency === NotificationUrgency.Critical ? Colours.layer(Colours.palette.m3secondaryContainer, 0) : Colours.layer(Colours.palette.m3surfaceContainer, 0)
    radius: 0
