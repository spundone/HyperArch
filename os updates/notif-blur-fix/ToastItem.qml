...
StyledRect {
    ...
    color: {
        if (root.modelData.type === Toast.Success)
            return Colours.layer(Colours.palette.m3successContainer, 0);
        if (root.modelData.type === Toast.Warning)
            return Colours.layer(Colours.palette.m3secondary, 0);
        if (root.modelData.type === Toast.Error)
            return Colours.layer(Colours.palette.m3errorContainer, 0);
        return Colours.layer(Colours.palette.m3surface, 0);
    }
